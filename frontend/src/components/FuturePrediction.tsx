              ...
              <Card className="overflow-hidden border-border bg-card shadow-xl transition-all hover:shadow-2xl">
                <div className="flex flex-col">
                  <CardContent className="p-8">
                    ...
                    {/* Detailed AI Footnote */}
                    <div className="mt-8 flex items-center justify-center gap-6 text-[10px] font-bold uppercase tracking-widest text-muted-foreground">
